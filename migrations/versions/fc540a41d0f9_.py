...
Revision ID: fc540a41d0f9
Revises: 8357c28cbda4
Create Date: 2020-06-14 21:34:29.732817
...
revision = 'fc540a41d0f9'
down_revision = '8357c28cbda4'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', postgresql.UUID(), autoincrement=False, nullable=False),
    sa.Column('title', sa.VARCHAR(length=250, collation='NOCASE'), autoincrement=False, nullable=False),
