...
class User(db.Model, UserMixin):
	...
	subject_id = db.Column(db.Integer, db.ForeignKey('subject.id'), nullable=True)#test cascade
	section_id = db.Column(db.Integer, db.ForeignKey('section.id'), nullable=True)#ondelete='CASCADE'
...
class Thesis(db.Model):
	...
	research_area_id = db.Column(db.Integer, db.ForeignKey('area.id'), nullable=False)
...
thesis_contributors = db.Table('thesis_contributors',
	db.Column('user_id', db.Integer, db.ForeignKey('user.id', ondelete='CASCADE')),
	db.Column('thesis_id', db.Integer, db.ForeignKey('thesis.id', ondelete='CASCADE'))
	)
