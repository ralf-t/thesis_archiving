...
with app.app_context():
	...
	from thesisarchiving.models import Role, User, Semester, Program, Category #tinggal yung models idk why it worked lol
	...
	try:
		...
		db.session.commit() #to query superuser after
